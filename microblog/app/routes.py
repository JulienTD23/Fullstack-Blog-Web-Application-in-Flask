...
def index():
    ...
    posts = db.paginate(current_user.following_posts(), page=page, per_page=app.config['SHORT_POSTS_PER_PAGE'], error_out=False)
...
def explore():
    ...
    posts = db.paginate(query, page=page, per_page=app.config['LONG_POSTS_PER_PAGE'], error_out=False)
...
def user(username):
    ...
    posts = db.paginate(query, page=page, per_page=app.config['SHORT_POSTS_PER_PAGE'], error_out=False)
